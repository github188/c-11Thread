...
bool CMarkupSTL::FindElem( const char* szName,bool isLoopOnce)
{
...
bool CMarkupSTL::FindChildElem( const char* szName,bool isLoopOnce )
{
					...
					while ( 1 )
					{
						...
						if ( c == ';' )
						{
							...
							bIgnoreAmpersand = true;
								...
								|| c=='_' || c==':' || c=='-' || c=='.' || (unsigned char)c>0x7f )
							continue;
						break;
					}
				}
